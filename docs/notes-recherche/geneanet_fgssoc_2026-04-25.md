# Arbre Geneanet fgssoc (Françoise Gueur) — exploration 25 avril 2026 (soir)

## Identification du compte fgssoc
...
### Jurgis SMALSTYS (1881-1919)

- Né **3 mai 1881 Kamajai, Gouvernement de Kowno** (Russie tsariste, Lituanie)
- Décédé **6 juillet 1919 Pakriaunis** (38 ans)
- Profession : « Homme politique. Parti Social Démocrate lituanien »
- **Parents** : **Juozapas SMALSTYS × Karolyna GRIZAITE** ⭐ (nouveau : ses parents)
- Note décès fgssoc : *« Fusillé par les "Russes blancs" »* — ⚠️ **divergence** avec [*Mémoire Balte*](http://fle.paixactive.org/memoire-balte/) qui parle de nationalistes lituaniens (régiment Glovackis). À recouper.

## Branche Majoros-Kramer (Hongrie) — vue selon fgssoc

```
Jozsef KRAMER × ?              Joseph MONTAG × Zsofia HEIDUSKA
       │                                  │
       └── Zsimond KRAMER †1928           └── Odon MAJOROS (1884-1966)
                  │                                  │
                  └── Sarolta BECK †1937 ←── ⚭ ───┘
                              │
                              └── Maria KRAMER ⚭ Odon MAJOROS
                                          │
...
> Ferenç MAJOROS marié 1948 Verviers à Yurgita SMOLSKI — **Divorce en 1951**.
...
L'arbre fgssoc compte **1 638 noms de famille** sur 4 184 individus. Les branches principales explorées :

- **Geelens-Parisis-Stembert-Francotte** : Verviers, ~1795-aujourd'hui
- **Smalstys-Smolski** : Kamajai (Lituanie), ~1881-2012
- **Kramer-Beck-Montag-Heiduska** : Hongrie, ~1872-2008 (héritage des contributions Yannick/Michel)
- **Gueur** : famille Françoise (à explorer si pertinent)

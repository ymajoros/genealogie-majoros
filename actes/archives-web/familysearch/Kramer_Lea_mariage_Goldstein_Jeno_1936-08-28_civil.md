...
- **ARK image** : [`3:1:S3HY-6S23-BSF`](https://www.familysearch.org/ark:/61903/3:1:S3HY-6S23-BSF?view=index) (image 426 / 855)
- **Image Group Number** : `004403198`
- **Collection** : *Budapest, Pest-Pilis-Solt-Kiskun, Hungary records* — Mariages 1936
- **Archive d'origine** : Budapesten a Városi Levéltárban (= **BFL — Budapest Főváros Levéltára**)
- **Folyószám (numéro d'ordre)** : **1504**
- **PDF local** : [`Kramer_Lea_mariage_Goldstein_Jeno_1936-08-28_civil.pdf`](Kramer_Lea_mariage_Goldstein_Jeno_1936-08-28_civil.pdf)

## Lecture directe de l'acte (folyószám 1504)

| Champ | Valeur |
|---|---|
| Helye / ideje (lieu/date du mariage) | **Budapest, 1936 augusztus 28** |
| **A vőlegény (le marié)** | **Goldstein Jenő** |
| Vőlegény vallása | izr. (israélite) |
| Vőlegény szül. helye / ideje | **Hunyad m.** (= Vajdahunyad / Hunedoara, Roumanie post-1920), **1904 márc. 31** ✓ |
| Vőlegény lakhely | Budapest VII., **Károly u. 3** (ou similaire) |
...
| Anyakönyvvezető | Tihanyi Bódog (?) |

## Confirmations apportées

### Sur Lea Krámer
- ✓ **Lea Krámer existait** (acte civil hongrois primaire, image visible)
- ✓ **Fille de notre Krámer Zsigmond × Beck Sarolta** (mention explicite « néhai Krámer Simon » + « Beck Sarolta » dans la rubrique parents de la mariée)
- ✓ **Mariée le 28 août 1936 Budapest** à Goldstein Jenő (date FS Tree GXXH-TDT confirmée)
- ✓ Domicile au moment du mariage : **VII. Károly u. 3** (Erzsébetváros — quartier juif)

### Sur Goldstein Jenő
- ✓ Né **31 mars 1904 Hunyad megye** (= comté de Vajdahunyad / Hunedoara) — confirmation de la donnée FS Tree GXXH-PWQ
- ✓ Domicile au mariage : **VII. Károly u. 3** (cohabitation avec Lea)
...
1. **README §3.6** : titre « 3ᵉ enfant *présumé* » → à reformuler en **« 3ᵉ enfant confirmé »**
2. **Audit doc** : avertissement fondamental → à **lever**, mais hypothèses secondaires (Israël, Shoah, Marishka) restent ouvertes
3. **Anomalie persistante non résolue** : pourquoi Lea **absente** des faire-part de ses parents (Pesti Hírlap 1928 Zsigmond ; Pesti Napló 1937 Sarolta) ? Hypothèses :
   - À 26 ans en 1928, **non encore mariée** → peut-être omise du faire-part par convention (les enfants célibataires apparaissent sous le terme générique « gyermekei » sans nommer)
   - À 35 ans en 1937, **mariée depuis 1 an** → l'omission est **plus surprenante**, mais peut s'expliquer par éloignement géographique (Hunyad / Roumanie ?) ou par structure du faire-part (qui ne nomme que les hommes/aînés)
4. **Hypothèse Marishka = fille de Lea & Jenő** : à nouveau plausible
5. **27 hits Új Kelet « Goldstein Jenő » Tel-Aviv 1949-77** : présomption d'émigration en Israël **renforcée** maintenant que l'identité du couple est confirmée

## Lien permanent FamilySearch

<https://www.familysearch.org/ark:/61903/3:1:S3HY-6S23-BSF?view=index>

(Source attachée à la fiche FS [GXXH-YFJ](https://www.familysearch.org/tree/person/details/GXXH-YFJ) Zsigmond Kramer par utilisateur **XXY29** le 15 juin 2022.)

...
Néanmoins, l'acte de décès d'Ödön (Budapest XIV, 12 août 1966, cert. n° 978 — FamilySearch ARK [`1:1:6V1G-YBG7`](https://www.familysearch.org/ark:/61903/1:1:6V1G-YBG7)) indexe le père sous la forme hongroise « Majoros József ». La mention est très probablement une réinscription rétrospective faite par le clerc, qui porte le nom actuel du fils jusqu'au parent défunt. **La présence ou non, dans le folio original (non encore lisible à haute résolution), de la forme « Montag » plutôt que « Majoros » reste à vérifier visuellement sur l'image intégrale `actes/ODon-Majoros-deces-1966-Budapest-XIV-cert978.jpg`.**

![Acte de décès Ödön Majoros](actes/ODon-Majoros-deces-1966-Budapest-XIV-cert978_preview.jpg)
...
4. **Jozsef Montag / Majoros sur l'acte de 1966** — Lire l'image haute résolution de l'acte pour savoir si le clerc a écrit « Montag » ou « Majoros ».
5. **Date de naissance d'Ödön (1884 vs 1888)** — Fragment de registre de Zenta, Arhiv Vojvodine.
6. **Décret de magyarisation Elyas Montag → Ödön Majoros** — Belügyi Közlöny / Budapesti Közlöny, fin XIXᵉ ou début XXᵉ.
7. **Parenté exacte Ödön ↔ Montag Henrik (1882)** — Registres Zenta ; Pejin 2003 cite les deux hommes sans lier.
8. **Heiduska Zsófia** — Lieu de naissance (Topolya ? Péterréve ? Zenta ?) et relation avec les Heiduska recensés par Pejin 2003.
9. **Kramer-Beck — actes d'état civil** — Archives de Nitra (SK) et Komárno (SK).
10. **Naissance Ferenc Imre 1923** — Budapest Születések 1923, BFL.
11. **Décès Maria Kramer ~1983** — Kormányhivatal (BFKH) + Chevra Kadisha (Síp utca 12).
12. **Ferenc Majoros attaché à Varsovie 1948** — MNL OL, fonds Külügyminisztérium, dossier personnel.
...
├── dossier-Majoros-Kramer.md              (document de travail)
├── rapport-Majoros.md                     (ce rapport)
├── actes/
